...
funcionalidad de analytics implementada.**
...
no hay tracking de vistas implementado en la app. Solo el admin podría insertar
...
1. ~~**No hay gestión de usuarios real**~~ — Parcialmente resuelto: se
   agregaron `ChangeUserRole` y `SuspendUser`. Falta eliminar usuarios.
